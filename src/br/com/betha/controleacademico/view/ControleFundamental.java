...
public class ControleFundamental extends JFrame {
	...
	public ControleFundamental() {
		setResizable(false);
		setTitle("Controle Ensino Fundamental");
		...
		panelInferior.setBackground(new Color(255, 204, 255));
				...
				panelInferior.add(btnSalvar);
						...
						btnExcluir.addActionListener(new ActionListener() {
							...
							public void actionPerformed(ActionEvent arg0) {
								AlunoFundamentalDAO dao = new AlunoFundamentalDAO();
								
								if (!txCodigo.getText().equals("")) {
									int codigo = Integer.parseInt(txCodigo.getText());
									dao.deleteAlunoFundamental(codigo);
								} else {
									dao.SemDados();
								}
							}
						...
						btnSalvar.addActionListener(new ActionListener() {
							...
							public void actionPerformed(ActionEvent arg0) {
							    ...
							    fund.setPeriodo(txPeriodo.getText());
							    fund.setVencMatricula(txVencimentoMat.getText());
							    fund.setPercentDesc(Double.parseDouble(txPercDesc.getText()));
							    fund.setPercentAcresc(Double.parseDouble(txPercAcre.getText()));
							    fund.setObservacao(txObs.getText());
								
								AlunoFundamentalDAO dao = new AlunoFundamentalDAO();
								
								if (!txCodigo.getText().equals("")) {
									fund.setCodigo(Integer.parseInt(txCodigo.getText()));
									dao.editarAlunoFundamental(fund);
								} else {
									dao.inserirAlunoFundamental(fund);
								}
								dispose();
							}
		...
		txPercDesc.setColumns(10);
				...
				painelFundo.add(panel);
						...
						JLabel lblEnsinoFundamental = new JLabel("Controle Ensino Fundamental");
						lblEnsinoFundamental.setHorizontalAlignment(SwingConstants.TRAILING);
						panel.add(lblEnsinoFundamental);
						lblEnsinoFundamental.setVerticalAlignment(SwingConstants.TOP);
						lblEnsinoFundamental.setFont(new Font("Tahoma", Font.BOLD, 16));
						lblEnsinoFundamental.setForeground(new Color(0, 0, 0));
