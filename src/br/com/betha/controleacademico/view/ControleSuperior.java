...
public class ControleSuperior extends JFrame {
	...
	public ControleSuperior() {
		setResizable(false);
		setTitle("Controle Ensino Superior");
		...
		panelInferior.setBackground(new Color(204, 255, 153));
		...
		txPercDesc.setColumns(10);
				...
				painelFundo.add(panel);
						...
						JLabel lblEnsinoSuperior = new JLabel("Controle Ensino Superior");
						panel.add(lblEnsinoSuperior);
						lblEnsinoSuperior.setVerticalAlignment(SwingConstants.TOP);
						lblEnsinoSuperior.setFont(new Font("Tahoma", Font.BOLD, 16));
						lblEnsinoSuperior.setForeground(new Color(0, 0, 0));
